...
begin
  ...
  begin
    ...
    with TExtDataField.AddTo(Fields) do
    begin
      Name := 'price';
      TypeJS := 'float'
    end;
    ...
    Data := JSArray('["3m Co",71.72,0.02,0.03,"2009/01/02"],' + '["Alcoa Inc",29.01,0.42,1.47,"2009/01/02"],' +
      ...
      '["AT&T Inc.",31.61,-0.48,-1.54,"2009/01/02"],' + '["Boeing Co.",75.43,0.53,0.71,"2009/01/02"],' +
      '["Caterpillar Inc.",67.27,0.92,1.39,"2009/01/02"],' + '["Citigroup, Inc.",49.37,0.02,0.04,"2009/01/02"],' +
      ...
      '["Hewlett-Packard Co.",36.53,-0.03,-0.08,"2009/01/02"],' + '["Honeywell Intl Inc",38.77,0.05,0.13,"2009/01/02"],'
      + '["Intel Corporation",19.88,0.31,1.58,"2009/01/02"],' +
      '["International Business Machines",81.41,0.44,0.54,"2009/01/02"],' +
      '["Johnson & Johnson",64.72,0.06,0.09,"2009/01/02"],' + '["JP Morgan & Chase & Co",45.73,0.07,0.15,"2009/01/02"],'
      + '["McDonald\"s Corporation",36.76,0.86,2.40,"2009/01/02"],' +
      '["Merck & Co., Inc.",40.96,0.41,1.01,"2009/01/02"],' + '["Microsoft Corporation",25.84,0.14,0.54,"2009/01/02"],'
      + '["Pfizer Inc",27.96,0.4,1.45,"2009/01/02"],' + '["The Coca-Cola Company",45.07,0.26,0.58,"2009/01/02"],' +
  ...
  ColorValue := JSFunction('V', 'if(V>0){return "<span style=''color:green''>" + V + "</span>";}else ' +
    'if(V<0){return "<span style=''color:red''>" + V + "</span>";}' + 'return V;');
...
//procedure TArrayGrid.RowSelectOnRowselect(This: TExtGridRowSelectionModel; RowIndex: Integer; R: TExtDataRecord);
//begin
