...
begin
  ...
  with TExtDataField.AddTo(Data) do
  begin
    Name := 'common';
    TypeJS := 'string'
  end;
  ...
  begin
    Name := 'price';
    TypeJS := 'float'
  end; // automatic date conversions
  with TExtDataField.AddTo(Data) do
  begin
    Name := 'availDate';
  ...
  begin
    ...
    begin
      ...
      with TExtFormComboBox(Editor) do
      begin
    ...
    begin
      ...
      with TExtFormNumberField(Editor) do
      begin
        MaxValue := 100000;
        AllowBlank := false;
        AllowNegative := false;
    ...
    begin
      ...
      with TExtFormDateField(Editor) do
      begin
        Format := 'm/d/Y';
    ...
    with TExtButton.AddTo(TBarArray) do
    begin
...
procedure TEditableGrid.AddPlant;
begin
  Grid.StopEditing;
  with DataStore do
    Insert(0, JSArray('new ' + Plant.JSName +
      '({common:"New Plant 1",light:"Mostly Shade",price:0,availDate:(new Date()).clearTime(),indoor:false})'));
